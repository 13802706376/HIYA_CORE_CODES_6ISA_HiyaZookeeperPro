package com.hiya.zookeeper.queue;
...
/**
 * 
 * A <a href="package.html">protocol to implement a distributed queue</a>. 利用
 * zookeeper 构建分布式 队列
 *
...
public class DistributedQueue
{
     ...
     */
    public String smallestChildName() throws KeeperException, InterruptedException
    {
    ...
    public byte[] element() throws NoSuchElementException, KeeperException, InterruptedException
    {
        ...
        // the child with the smallest sequence number in orderedChildren might be gone
        // by the time we check.
        // We don't call getChildren again until we have tried the rest of the nodes in
        // sequence order.
        while (true)
        {
            try
